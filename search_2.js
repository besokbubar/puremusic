var searchmp3 = new XMLHttpRequest();
  var urlmp3 = "http://api.soundcloud.com/tracks.json?q="+q+"&limit=15&offset="+page+"&client_id="+lasmlkamcklamsclkaaslmdlmawlkdklsakdlksa+"";
...
var balik=page-1;
  ...
  if (balik > 0) {
    var prev='<a href="/site-search-music.html?to-q='+q+'&to-page='+balik+'" class="arr-left"><i class="ic icr-left"></i></a>'; }else{ 
    var prev='';}
  var next='<a href="/site-search-music.html?to-q='+q+'&to-page='+lanjut+'" class="arr-right"><i class="ic icr-right"></i></a> ';
